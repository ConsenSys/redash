...
REMOTE_JWT_EXPIRED_ENDPOINT = os.environ.get("REDASH_REMOTE_JWT_EXPIRED_ENDPOINT", '/login')
...
# Customize the login and refresh views
LOGIN_MANAGER_LOGIN_VIEW = os.environ.get("REDASH_LOGIN_MANAGER_LOGIN_VIEW", REMOTE_JWT_EXPIRED_ENDPOINT if REMOTE_JWT_LOGIN_ENABLED else '/login')
LOGIN_MANAGER_REFRESH_VIEW = os.environ.get("REDASH_LOGIN_MANAGER_REFRESH_VIEW", REMOTE_JWT_REFRESH_PROVIDER if REMOTE_JWT_LOGIN_ENABLED else '/login')

# Photic specific variables
INLINE_QUERY_ROOT_URL = os.environ.get("REDASH_INLINE_QUERY_ROOT_URL", '')