...
LOGIN_MANAGER_LOGIN_VIEW = os.environ.get("REDASH_LOGIN_MANAGER_LOGIN_VIEW", REMOTE_JWT_EXPIRED_ENDPOINT)
LOGIN_MANAGER_REFRESH_VIEW = os.environ.get("REDASH_LOGIN_MANAGER_REFRESH_VIEW", REMOTE_JWT_REFRESH_PROVIDER)